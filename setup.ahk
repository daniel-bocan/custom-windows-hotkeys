...
; This script create copy of default Power saver Power scheme, set its important properties and save GUID of the scheme to the local_config.ini file.

#Requires AutoHotkey v2.0

guidKey := "powerSaverGUID"  ; Key in local_config.ini file that stores value of GUID of Power saver Power scheme

; The script will execute only if the local_config.ini file doesn't exists or if powerSaverGUID variable value is empty to prevent unwanted execution
if IniRead("local_config.ini", "GUID", guidKey, "") == ""
{
    ...
    guid := GetGUID(output)
    IniWrite(guid, "local_config.ini", "GUID", guidKey)  ; Save GUID to local_config.ini file
